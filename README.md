...
# 2. Скопіювати приклад конфігурації `.env`
# Windows:
...
> Для роботи AI-коуча потрібно додати ключ одного з провайдерів у файл `.env` (OpenAI, Anthropic, Gemini, Free LLM або NVIDIA).
...
* `/ai` — AI-коуч: аналіз профілю та рекомендації на основі OpenDota-статистики
